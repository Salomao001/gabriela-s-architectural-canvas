...
const Hero = () => {
  return <section id="inicio" className="min-h-screen relative flex items-center">
      ...
      <div className="absolute bottom-40 left-16 w-20 h-20 border border-beige-dark/20 hidden lg:block" style={{
      animationDelay: "2s"
    }} />
      ...
      <div className="container mx-auto px-6 lg:px-12 xl:px-20 pt-24">
        <div className="grid lg:grid-cols-[1fr_auto] gap-12 lg:gap-16 xl:gap-24 items-center">
          ...
          <div className="order-2 lg:order-1 space-y-8">
            <div className="space-y-4">
              <p className="subtitle opacity-0 animate-fade-in" style={{
              animationDelay: "0.2s"
            }}>
                Arquiteta & Urbanista
              </p>
              <h1 className="section-title opacity-0 animate-fade-in" style={{
              animationDelay: "0.4s"
            }}>
                Gabriela Del Nobile
              </h1>
              <div className="w-16 h-px bg-beige-dark opacity-0 animate-fade-in" style={{
              animationDelay: "0.6s"
            }} />
            </div>
            
            <p className="text-stone-light leading-relaxed max-w-lg opacity-0 animate-fade-in" style={{
            animationDelay: "0.8s"
          }}>
          ...
          {/* Profile Image */}
          <div className="order-1 lg:order-2 lg:justify-end lg:pr-4 xl:pr-8 flex items-center justify-end">
            <div className="relative opacity-0 animate-fade-in-right" style={{
            animationDelay: "0.4s"
          }}>
              {/* Decorative frame */}
              ...
              <div className="relative w-72 h-96 md:w-80 md:h-[28rem] lg:w-96 lg:h-[32rem] overflow-hidden">
                <img src={profileImage} alt="Gabriela Del Nobile" className="w-full h-full object-cover object-top grayscale-[20%]" />
                {/* Overlay gradient */}
        ...
        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-0 animate-fade-in" style={{
        animationDelay: "1.2s"
      }}>
